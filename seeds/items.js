  ...
  return knex('Items').del()
    .then(function () {
      ...
      return knex('Items').insert([
        ...
        {id: 3, imageurl: '/images/dougal.jpg', name: 'Deep Dive Dougs', description: 'Wedding speech writer extrodinaire', price: 10000000},
        ...
        {id: 9, imageurl: '/images/emergency.jpg', name: 'Emergency Evacuation Procedures', description: 'For all life-saving escape procedures', price: 4000},
